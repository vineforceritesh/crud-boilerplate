...
namespace UserCrud.Migrations
{
    ...
    [Migration("20260120050831_Initial_Create_With_Student_Collage")]
    partial class Initial_Create_With_Student_Collage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserCrud.Collage.Collage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("UserCrud.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("UserCrud.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UserCrud.Students.Student", b =>
                {
                    b.HasOne("UserCrud.Collage.Collage", "Collage")
                        .WithMany()
