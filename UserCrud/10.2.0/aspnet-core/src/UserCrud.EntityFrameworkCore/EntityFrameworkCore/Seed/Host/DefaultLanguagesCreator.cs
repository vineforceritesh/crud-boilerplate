...
namespace UserCrud.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly UserCrudDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = UserCrudConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(UserCrudDbContext context)
    {
        _context = context;
    }
