...
public abstract class UserCrudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static UserCrudWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(UserCrudWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<UserCrudDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<UserCrudDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<UserCrudDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<UserCrudDbContext, Task<T>> func)
    {
        T result;
